...
# Function to create data.yaml with class names
def create_data_yaml(data_yaml_path, output_path):
    # Load class names from labels.txt
    with open(LABELS_PATH, 'r') as file:
        class_names = file.read().strip().splitlines()

    # Prepare data.yaml structure
    data_yaml_content = {
...
# Execute the split and create data.yaml
split_dataset(DATASET_PATH)
create_data_yaml(DATA_YAML_PATH, OUTPUT_PATH)
